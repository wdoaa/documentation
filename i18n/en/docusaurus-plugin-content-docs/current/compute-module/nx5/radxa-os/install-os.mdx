...
Install to a microSD card requires preparation:
...
&emsp;[upgrade_tool](/general-tutorial/rksdk/upgrade_tool) (Can be installed to multiple devices simultaneously)
