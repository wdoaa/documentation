...
:::caution 注意
此教程仅适用于刷写可移动 eMMC 模块，板载 eMMC 需使用[线刷](/general-tutorial/rksdk/rkdevtool)的方式。
:::
...
将镜像写入 NVMe SSD 后，要从 NVMe SSD 启动，您需要将 bootloader 写入 SPI Flash。详情请查看安装 [bootloader 到 SPI Flash](/general-tutorial/rksdk/rkdevtool)
